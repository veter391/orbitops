 ...
 * rate-limited and strictly validated. `GET /v1/feedback` requires auth — it is
 * how the owner reads what came in. (In production the read would be gated to an
 * admin role; today any authenticated operator can read it.)
 */
