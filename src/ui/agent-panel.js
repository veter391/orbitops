        ...
        <div class="proposal__head-info">
          ...
          <div class="proposal__chips">
            ...
            ${proposal.aiMode === 'live'
              ? `<span class="proposal__chip proposal__chip--ok" title="Reasoning generated by real OpenRouter model calls">LIVE AI</span>`
              : `<span class="proposal__chip" title="${proposal.aiError ? renderText(proposal.aiError) : 'No OpenRouter key configured — using scripted demo reasoning'}">SIMULATED${proposal.aiError ? ' · AI unavailable' : ''}</span>`}
          </div>
        </div>
    ...
    <div class="chain-step">
      ...
      <div class="chain-step__body">
        <div class="chain-step__title">
          ...
          ${isLive ? `<span class="chain-step__source chain-step__source--live" title="Genuine LLM call via OpenRouter">LIVE AI · ${step.model || ''}</span>` : step.source === 'simulated' ? `<span class="chain-step__source">SIMULATED</span>` : ''}
        </div>
